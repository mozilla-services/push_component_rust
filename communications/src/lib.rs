...
pub trait Connection {
    ...
    fn connect<C: Connection>(options: Option<HashMap<String, String>>) -> Result<C, ConnectionError>;
    ...
    fn update(&self, channel_id: &str, auth: &str, new_token: &str) -> Result<bool, ConnectionError>;
    ...
    fn broadcast_subscribe(&self, broadcast: BroadcastValue) -> Result<BroadcastValue, ConnectionError>;
